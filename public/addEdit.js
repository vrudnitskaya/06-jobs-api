...
export const showAddEdit = async (jobId) => {
    if (!jobId) {
        ...
        try {
            ...
            console.log(err);
            message.textContent = "A communications error has occurred while deleting.";
            showJobs();
        }
...
export const showDelete = async (jobId) => {
    ...
    try {
        ...
        console.log(err);
        message.textContent = err.message || "A communications error has occurred while deleting the job.";
        showJobs();
    }
    enableInput(true);
};